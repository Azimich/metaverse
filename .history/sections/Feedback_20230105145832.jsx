    ...
    >
      ...
      >
        <div className="feedblack-gradient">
          ...
          <p className="mt-[24px] font-normal sm:text-[18px] text-[12px] sm:leading-[45px] leading-[16px] text-white">
      ...
      >
        <img src="/planet-09.png" alt="planet-09" className="w-full h-auto lg:h-[610px] min-h-[210px] object-cover rounded-[40]" />
      </motion.div>
    </motion.div>
  </section>
);
